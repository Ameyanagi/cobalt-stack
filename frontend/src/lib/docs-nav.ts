  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Components', slug: 'components', file: '/docs/frontend/components.md' },
      {
        ...
        file: '/docs/frontend/state-management.md',
      },
  ...
  },
  {
    ...
    items: [
      { title: 'Authentication', slug: 'authentication', file: '/docs/guides/authentication.md' },
      {
        ...
        file: '/docs/guides/email-verification.md',
      },
      {
        title: 'Admin Dashboard',
        slug: 'admin-dashboard',
        file: '/docs/guides/admin-dashboard.md',
      },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        file: '/docs/contributing/testing-requirements.md',
      },
    ],
  },
  {
    ...
    items: [{ title: 'Overview', slug: 'overview', file: '/docs/troubleshooting/README.md' }],
  },
]

// Flatten all pages for easy lookup
export const allDocs = docsNav.flatMap(
  (section) =>
...
export function getDocBySlug(sectionSlug: string, pageSlug: string) {
  return allDocs.find((doc) => doc.sectionSlug === sectionSlug && doc.slug === pageSlug)
}
